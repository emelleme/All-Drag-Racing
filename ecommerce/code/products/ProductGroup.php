...
class ProductGroup extends Page {
	...
	function requireDefaultRecords() {
		...
		if(!DataObject::get_one('ProductGroup')) {
			...
			if(method_exists('DB', 'alteration_message')) DB::alteration_message('Product group page \'Products\' created', 'created');
			...
			if(method_exists('DB', 'alteration_message')) DB::alteration_message('Product group page \'Example product group\' created', 'created');
		}
	}
